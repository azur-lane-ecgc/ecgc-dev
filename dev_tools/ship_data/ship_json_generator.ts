...
import type { ShipData as ProcessedShipData } from "@data/ship_data/types"
import {
...
const OUTPUT_PATH = "src/data/ship_data/ship_data.json"
...
const writeShipDataToFile = async (
  ...
  Object.keys(ships).forEach((id) => {
    ...
    const roles = shipRoleParse(ship, fleetType).slice(0, 5)
